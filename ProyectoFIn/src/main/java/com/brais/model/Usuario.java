...
public class Usuario {
	...
	private Integer id;
	private String username;//nick del ususario
	private String nombre; //nombre del ususario
	private String email;//email del usuario
	private String password;//contraseña del usuario
	private Integer estatus;	//para saber si un usuario esta bloqueado o no
	...
	// Relacion ManyToMany (Un usuario tiene muchos perfiles)
		...
		@JoinTable(name = "usuarioPerfil", // tabla intermedia
				joinColumns = @JoinColumn(name = "idUsuario"), // Key en la tabla de UsuarioPerfil
